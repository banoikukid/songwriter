...
- **Behavior Specificity (Phụ trợ tùy chọn):** Cử chỉ, hành vi sinh hoạt cụ thể; chỉ giữ lại nếu bộc lộ sự thật cảm xúc lớn hơn. Tính quen thuộc của một hành vi đời thường tự thân không tạo nên giá trị ca từ hay cảm xúc.
- **Đại chúng ≠ Đời thường quen mắt (Mainstream Relatability ≠ Mundane Commonness):** *"Đại chúng không phải là kể những việc ai cũng làm; đại chúng là chạm vào cảm giác nhiều người từng sống qua."* Sự đồng cảm đại chúng đến từ sự thật cảm xúc được sẻ chia (*shared emotional truth*), không đến từ việc kiểm kê các sinh hoạt thường nhật. Chi tiết đời thường chỉ có giá trị khi tự nhiên chuyên chở biến chuyển cảm xúc, khoảng vắng, hay chức năng âm nhạc thực sự.
...
- **Phóng chiếu người nghe (Mainstream Pop/Ballad Heuristic):** *"Đủ riêng để thật, đủ mở để người nghe thấy mình."* Người nghe nhận ra đời sống cảm xúc của chính họ chứ không nhất thiết phải làm đúng hành vi được kể. Verse có thể mang nét riêng của nhân vật; Chorus thường mở để người nghe có thể hát như chính tiếng lòng của họ mà không cần thuộc lòng tiểu sử nhân vật. (Đây là chỉ dẫn craft, tuyệt đối không biến thành Projection Gate hay thang điểm).
